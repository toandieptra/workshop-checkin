...
export default function SettingsPage() {
  ...
  return (
    <div className="w-full px-4 py-6 sm:px-6 lg:flex lg:h-[calc(100dvh-3.5rem)] lg:min-h-0 lg:flex-col lg:overflow-hidden lg:py-5">
      <div className="mb-5 shrink-0">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-brand-teal">Quản trị hệ thống</p>
      ...
      <div className="grid items-start gap-5 lg:min-h-0 lg:flex-1 lg:grid-cols-[230px_minmax(0,1fr)] lg:grid-rows-1">
        <aside className="overflow-hidden rounded-lg border border-line bg-white shadow-sm lg:min-h-0 lg:overflow-y-auto">
          <nav aria-label="Danh mục cài đặt" className="settings-tabs flex gap-2 overflow-x-auto p-2 pr-10 lg:flex-col lg:pr-2">
            {visibleTabs.map((tab) => {
        ...
        <section className="settings-panel min-w-0 lg:flex lg:h-full lg:min-h-0 lg:flex-col">
