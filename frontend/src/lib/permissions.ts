...
export const PERMISSIONS = {
  ...
  reportsView: "reports.read",
  reportsExport: "reports.export",
  zbsView: "zbs.read",
  zbsManage: "zbs.manage",
  zaloTemplatesView: "zalo_templates.read",
  zaloTemplatesManage: "zalo_templates.manage",
  zaloTemplatesCreate: "zalo_templates.create",
  zaloTemplatesEdit: "zalo_templates.edit",
  zaloTemplatesDelete: "zalo_templates.delete",
  zaloMessagesView: "zalo_messages.read",
  zaloMessagesSend: "zalo_messages.send",
  zaloMessagesBulkSend: "zalo_messages.bulk_send",
