...
echo "[2/6] Pin buildx to 'default' (do not create new builder)"
...
echo "[3/6] Build images (linux/amd64, --pull, --load) via default builder"
...
echo "[4/6] Tag :latest for compose"
